    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <form id="product-form" action="{{ route('menu.update',$menu->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="parent" class="form-control">
                                                    ...
                                                    <option value="{{ $menu1->id }}" {{ ($menu1->id==$menu->parent_id)?'selected':'' }}>{{ $menu1->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('parent')
                                                    <p style="color: red">{{ $message }}</p>
                                        ...
                                        <div class="col-md-12 text-center" style=" margin-top: 10px;margin-bottom: 10px;">
                                            <button type="submit" class="btn btn-primary">Update Menu <i
