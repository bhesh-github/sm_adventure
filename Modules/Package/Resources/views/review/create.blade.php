                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-success">
                            <div class="card-header">
                                ...
                                <a href="{{ route('review.index', $package->id) }}"
                                    class="btn btn-danger float-right">Back</a>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="product-form" action="{{ route('review.store') }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="rating" id="rating" class="form-control" required>
                                                    <option value="" disabled selected>Select Rating</option>
                                                        <option value="1" {{ 1 == old('rating') ? 'selected' : '' }}>1</option>
                                                        <option value="2" {{ 1 == old('rating') ? 'selected' : '' }}>2</option>
                                                        <option value="3" {{ 1 == old('rating') ? 'selected' : '' }}>3</option>
                                                        <option value="4" {{ 1 == old('rating') ? 'selected' : '' }}>4</option>
                                                        <option value="5" {{ 1 == old('rating') ? 'selected' : '' }}>5</option>
                                                </select>
                                                @error('category')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
