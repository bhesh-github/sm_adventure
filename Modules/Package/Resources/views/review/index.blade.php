...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">Package Reviews</li>
    </ol>
@endsection
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title float-right"><a class="btn btn-info text-white"
                                        href="{{ route('review.create', $package->id) }}"><i class="fa fa-plus"></i>
                                        Create Review</a> </h3>
                                    ...
                                    <tbody>
                                        @foreach ($reviews as $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->name }}</td>
                                                <td>
                                                    <img src="{{ asset('upload/images/review/' . $value->image) }}"
                                                        width="100px">
                                                </td>
                                                <td>{{ $value->rating }}</td>
                                                <td>{{ $value->title }}</td>
                                                ...
                                                <td class="text-center">
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-left">
                                                                    <form action="{{ route('review.update', $value->id) }}" enctype="multipart/form-data"
                                                                        method="POST">
                                                                        @csrf
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="rating" class="form-control"
                                                                                ...
                                                                                <option value="" disabled>Select
                                                                                    Rating</option>
                                                                                <option value="1"
                                                                                    {{ 1 == $value->rating ? 'selected' : '' }}>
                                                                                    1</option>
                                                                                <option value="2"
                                                                                    {{ 2 == $value->rating ? 'selected' : '' }}>
                                                                                    2</option>
                                                                                <option value="3"
                                                                                    {{ 3 == $value->rating ? 'selected' : '' }}>
                                                                                    3</option>
                                                                                <option value="4"
                                                                                    {{ 4 == $value->rating ? 'selected' : '' }}>
                                                                                    4</option>
                                                                                <option value="5"
                                                                                    {{ 5 == $value->rating ? 'selected' : '' }}>
                                                                                    5</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="form-group">
                                                    ...
                                                    <a href="{{ route('review.destroy', $value->id) }}"
