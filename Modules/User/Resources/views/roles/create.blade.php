                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="access_packages" {{ old('access_packages') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="access_packages">Access</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="show_packages" {{ old('show_packages') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="show_packages">View</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="create_packages" {{ old('create_packages') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="create_packages">Create</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="edit_packages" {{ old('edit_packages') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="edit_packages">Edit</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="delete_packages" {{ old('delete_packages') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete_packages">Delete</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="access_company" {{ old('access_company') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="access_company">Access</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="show_company" {{ old('show_company') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="show_company">View</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="create_company" {{ old('create_company') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="create_company">Create</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="edit_company" {{ old('edit_company') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="edit_company">Edit</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="delete_company" {{ old('delete_company') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete_company">Delete</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
