...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('faqs.index') }}">Subscription</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <form id="product-form" action="{{ route('subscriptions.send.mail') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="message" class="summernote" placeholder="Enter Message" required>{{ old('message') }}</textarea>
                                                @error('message')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
