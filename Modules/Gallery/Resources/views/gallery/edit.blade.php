...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('gallery.index') }}">FAQs</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <form id="product-form" action="{{ route('gallery.update', $gallery->id) }}" method="POST"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                    value="{{ $gallery->name }}" placeholder="Enter Name" required>
                                                @error('name')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="image">Image <small>( 243 x 263 )</small></label>
                                                ...
                                                <img src="{{ asset('upload/images/gallery/'.$gallery->image) }}" alt="{{ $gallery->title }}" width="200px">
                                                @error('image')
                                                        <p style="color: red">{{ $message }}</p>
                                                    @enderror
