...
INSERT INTO `menus` (`id`, `name`, `parent_id`, `page_id`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Test', NULL, 1, 'on', '2023-04-28 02:00:52', '2023-04-28 02:05:34');
...
(18, '2023_05_02_141357_create_contacts_table', 13),
(19, '2023_04_30_114105_create_subscriptions_table', 14);
...
(134, 'access_contact', 'web', NULL, NULL),
(135, 'show_contact', 'web', NULL, NULL),
(136, 'delete_contact', 'web', NULL, NULL),
(137, 'access_subscriptions', 'web', NULL, NULL),
(138, 'show_subscriptions', 'web', NULL, NULL),
(139, 'delete_subscriptions', 'web', NULL, NULL),
(140, 'send_mail', 'web', NULL, NULL);
...
(4, 'Wynne Haney', '<span style=\"color: rgba(0, 0, 0, 0.8); font-family: &quot;Source Sans Pro&quot;, sans-serif; font-size: 16.2px; letter-spacing: -0.0486px; text-align: justify;\">Lorem ipsum dolor sit amet consectetur adipiscing elit dictum non, eros habitant sed risus pellentesque parturient magnis facilisis, tristique etiam feugiat vulputate velit nunc iaculis curabitur. Neque litora mi lacus iaculis platea vehicula magna dui, auctor at augue sollicitudin suspendisse dapibus cubilia nisl, duis eu nam tortor facilisi phasellus nisi.</span>', 'on', '1680176672.jpg', '2023-03-30 05:59:32', '2023-03-30 05:59:51');
...
--
ALTER TABLE `menus`
  ADD CONSTRAINT `menus_page_id_foreign` FOREIGN KEY (`page_id`) REFERENCES `pages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
